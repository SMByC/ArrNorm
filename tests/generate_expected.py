...
SCENARIOS = [
    ...
    (
        "Pre-aligned ref, conv=0.95",
        "ref_adjusted2target.tif", {"conv_threshold": 0.95},
        [("img_norm", "target_norm_conv095.tif")],
    ),
    (
        "Pre-aligned ref, conv=0.999",
        "ref_adjusted2target.tif", {"conv_threshold": 0.999},
        [("img_norm", "target_norm_conv0999.tif")],
    ),
    (
        "Pre-aligned ref, t=0.90",
        "ref_adjusted2target.tif", {"ncp_threshold": 0.90},
